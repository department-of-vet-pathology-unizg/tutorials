...
Copared to Windows, Linux is also faster in everyday tasks. Take a look at a [Clear Linux](https://clearlinux.org/), a Linux OS developed by Intel (and optimized for deep learning). It is ridiculously fast.
